								...
								<div class="card-body">
									<div class="table-responsive">
										<table id="basic-datatables" class="table table-bordered table-head-bg-info table-bordered-bd-success" >
											...
											<tbody>
											<?php foreach ($locker_list as $new): ?>
												<tr>
                                                <td><?php echo $new['locker_agent']; ?></td>
                                                    <td><?php echo $new['locker_no']; ?></td>
                                                    <td><?php echo $new['locker_tool_id']; ?></td>
                                                    <td style="<?php 
                                                    ...
                                                    <td><?php echo $new['locker_condition']; ?></td>
                                                    <td><?php echo $new['locker_comment']; ?></td>
												</tr>
												<?php endforeach; ?>
											</tbody>
										</table>
