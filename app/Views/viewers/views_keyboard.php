								...
								<div class="card-body">
									<div class="table-responsive">
										<table id="basic-datatables" class="table table-bordered table-head-bg-info table-bordered-bd-success" >
											...
											<tbody>
											<?php foreach ($keyboard_list as $new): ?>
												<tr>
                                                <td style="<?php echo ($new['keyboard_status'] === 'Unserviceable') ? 'background-color: #ff9999;' : ''; ?>"><?php echo $new['agent']; ?></td>
                                                <td style="<?php echo ($new['keyboard_status'] === 'Unserviceable') ? 'background-color: #ff9999;' : ''; ?>"><?php echo $new['keyboard_equip_id']; ?></td>
                                                <td style="<?php 
                                                ...
                                                <td style="<?php echo ($new['keyboard_status'] === 'Unserviceable') ? 'background-color: #ff9999;' : ''; ?>"><?php echo $new['keyboard_brand']; ?></td>
                                                <td style="<?php echo ($new['keyboard_status'] === 'Unserviceable') ? 'background-color: #ff9999;' : ''; ?>"><?php echo $new['keyboard_model']; ?></td>
                                                <td style="<?php echo ($new['keyboard_status'] === 'Unserviceable') ? 'background-color: #ff9999;' : ''; ?>"><?php echo $new['keyboard_condition']; ?></td>
                                                <td style="<?php echo ($new['keyboard_status'] === 'Unserviceable') ? 'background-color: #ff9999;' : ''; ?>"><?php echo $new['keyboard_comment']; ?></td>
												</tr>
												<?php endforeach; ?>
											</tbody>
										</table>
