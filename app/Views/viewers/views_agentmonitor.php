								...
								<div class="card-body">
									<div class="table-responsive">
										<table id="basic-datatables" class="table table-bordered table-head-bg-info table-bordered-bd-success" >
											...
											<tbody>
											<?php foreach ($agentmonitor_list as $new): ?>
												<tr>
                                                <td><?php echo $new['agent']; ?></td>
                                                    <td style="<?php echo ($new['monitor_one'] === 'None') ? 'color: white; background-color: gray;' : ''; ?>"><?php echo $new['monitor_one']; ?></td>
                                                    <td style="<?php echo ($new['monitor_two'] === 'None') ? 'color: white; background-color: gray;' : ''; ?>"><?php echo $new['monitor_two']; ?></td>
                                                </tr>
												<?php endforeach; ?>
											</tbody>
										</table>
