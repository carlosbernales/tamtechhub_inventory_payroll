								...
								<div class="card-body">
									<div class="table-responsive">
										<table id="basic-datatables" class="table table-bordered table-head-bg-info table-bordered-bd-success" >
											...
											<tbody>
											<?php foreach ($monitor_list as $new): ?>
												<tr>
                                                    <td style="<?php echo ($new['monitor_status'] === 'Unserviceable') ? 'background-color: #ff9999;' : ''; ?>"><?php echo $new['monitor_equip_id']; ?></td>
                                                    <td style="<?php 
                                                    ...
                                                    <td style="<?php echo ($new['monitor_status'] === 'Unserviceable') ? 'background-color: #ff9999;' : ''; ?>"><?php echo $new['monitor_brand']; ?></td>
                                                    <td style="<?php echo ($new['monitor_status'] === 'Unserviceable') ? 'background-color: #ff9999;' : ''; ?>"><?php echo $new['monitor_model']; ?></td>
                                                    <td style="<?php echo ($new['monitor_status'] === 'Unserviceable') ? 'background-color: #ff9999;' : ''; ?>"><?php echo $new['monitor_condition']; ?></td>
                                                    <td style="<?php echo ($new['monitor_status'] === 'Unserviceable') ? 'background-color: #ff9999;' : ''; ?>"><?php echo $new['monitor_comment']; ?></td>
                                                    </tr>
												<?php endforeach; ?>
											</tbody>
										</table>
