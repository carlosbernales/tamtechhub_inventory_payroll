								...
								<div class="card-body">
									<div class="table-responsive">
										<table id="basic-datatables" class="table table-bordered table-head-bg-info table-bordered-bd-success" >
											...
											<tbody>
											<?php foreach ($webcam_list as $new): ?>
												<tr>
                                                <td style="<?php echo ($new['webcam_status'] === 'Unserviceable') ? 'background-color: #ff9999;' : ''; ?>"><?php echo $new['webcam_agent']; ?></td>
                                                    <td style="<?php echo ($new['webcam_status'] === 'Unserviceable') ? 'background-color: #ff9999;' : ''; ?>"><?php echo $new['webcam_equip_id']; ?></td>
                                                    <td style="<?php 
                                                    ...
                                                    <td style="<?php echo ($new['webcam_status'] === 'Unserviceable') ? 'background-color: #ff9999;' : ''; ?>"><?php echo $new['webcam_brand']; ?></td>
                                                    <td style="<?php echo ($new['webcam_status'] === 'Unserviceable') ? 'background-color: #ff9999;' : ''; ?>"><?php echo $new['webcam_model']; ?></td>
                                                    <td style="<?php echo ($new['webcam_status'] === 'Unserviceable') ? 'background-color: #ff9999;' : ''; ?>"><?php echo $new['webcam_condition']; ?></td>
                                                    <td style="<?php echo ($new['webcam_status'] === 'Unserviceable') ? 'background-color: #ff9999;' : ''; ?>"><?php echo $new['webcam_comment']; ?></td>
												</tr>
												<?php endforeach; ?>
											</tbody>
										</table>
