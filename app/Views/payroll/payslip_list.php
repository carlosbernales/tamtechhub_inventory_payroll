...
<div class="preloader">
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="card-header" style="display: flex; justify-content: space-between;">
                    <h5>Payslips</h5>
                    <a href="#" class="btn btn-success" id="send-all-emails" style="margin-right: 10px;">
                        ...
                        <table id="setting-default" class="table table-striped table-bordered nowrap">
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align: left;">Date Generated</th>
                                    <th>Agent</th>
                                    <th>Email</th>
                            ...
                            <tbody>
                                <?php foreach ($payslip as $new): ?>
                                    <tr>
                                        ...
                                        <td style="text-align: left;" class="agent-cell-clickable" data-toggle="modal" data-target="#editModal-<?php echo $new['id']; ?>">
                                            <?php $date = new DateTime($new['created_at']);echo $date->format('F j, Y');?>
                                        </td>
    ...
    <script src="<?= base_url('template/payroll_scripts.js') ?>"></script>
