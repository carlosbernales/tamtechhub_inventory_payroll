										...
										<table id="basic-datatables" class="table table-bordered table-head-bg-info table-bordered-bd-success" >
											...
											<?php foreach ($agent_list as $new): ?>
												<tr>
													...
													<td class="agent-cell-clickable"><?php echo $new['start_date_formatted']; ?></td>

													<td style ="width:10%"><a href="<?= site_url('files/VIew_' . $new['id']); ?>"><i class="fas fa-folder-open"></i> View</a></td>
												...
												<!-- EDIT  MODAL -->
													<div class="modal fade" id="editModal-<?php echo $new['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true" data-backdrop="true">
														...
														<div class="modal-content">
															...
															<form id="editCategoryForm-<?php echo $new['id']; ?>" action="<?= site_url('agents_update' . $new['id']) ?>" method="POST" enctype="multipart/form-data">
															<?= csrf_field(); ?>
            ...
            <div class="modal-content">
                ...
                <form action="<?= site_url('add_agent') ?>" method="POST">
                    <div class="modal-body">
						...
						<div class="form-group">
                            <label for="anotherAgentName">Start Date</label>
