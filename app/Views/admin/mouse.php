    ...
    <img src="<?= base_url('logindes/images/tamtechlogo.png') ?>" alt="Preloader">
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header" style="display: flex; justify-content: space-between;">
							        <h1>Mouse</h1>
                                    <a href="#" class="btn btn-success" data-toggle="modal" data-target="#myModal" style="margin-right: 10px;">+ <i class="fas fa-mouse"></i></a>
								</div>
								<div class="card-body">
									<div class="table-responsive">
										<table id="basic-datatables" class="table table-bordered table-head-bg-info table-bordered-bd-success" >
											...
											<tbody>
                                            <?php foreach ($mouse as $new): ?>
                                                <tr>
                                                    <td class="mouse_cell-clickable" style="<?php echo ($new['status'] === 'Unserviceable') ? 'background-color: #ff9999;' : ''; ?>"><?php echo $new['agent']; ?></td>
                                                    <td class="mouse_cell-clickable" style="<?php echo ($new['status'] === 'Unserviceable') ? 'background-color: #ff9999;' : ''; ?>"><?php echo $new['equip_id']; ?></td>
                                                    <td class="mouse_cell-clickable" style="<?php 
                                                    ...
                                                    <td class="mouse_cell-clickable" style="<?php echo ($new['status'] === 'Unserviceable') ? 'background-color: #ff9999;' : ''; ?>"><?php echo $new['brand']; ?></td>
                                                    <td class="mouse_cell-clickable" style="<?php echo ($new['status'] === 'Unserviceable') ? 'background-color: #ff9999;' : ''; ?>"><?php echo $new['model']; ?></td>
                                                    <td class="mouse_cell-clickable" style="<?php echo ($new['status'] === 'Unserviceable') ? 'background-color: #ff9999;' : ''; ?>"><?php echo $new['mouse_condition']; ?></td>
                                                    <td class="mouse_cell-clickable" style="<?php echo ($new['status'] === 'Unserviceable') ? 'background-color: #ff9999;' : ''; ?>"><?php echo $new['comment']; ?></td>
                                                    ...
                                                    <button class="btn btn-primary btn-sm hidden" data-toggle="modal" data-target="#editModal-<?php echo $new['id']; ?>" data-id="<?php echo $new['id']; ?>">Edit</button>
                                                        ...
                                                        <a href="<?= site_url('delete/mouse'.$new['id']) ?>" class="fa fa-trash delete" onclick="confirmMouseDelete(event)" style="font-size: 2em; color: red;"></a>
                                                    </td>
                                                </tr>
                                                ...
                                                <!-- EDIT  MODAL -->
                                                    <div class="modal fade" id="editModal-<?php echo $new['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true" data-backdrop="true">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <form id="editCategoryForm-<?php echo $new['id']; ?>" action="<?= site_url('mouse/update' . $new['id']) ?>" method="POST" enctype="multipart/form-data">
                                                            <input type="hidden" name="id" value="<?php echo $new['id']; ?>">
                                                            <?= csrf_field(); ?>

                                                            <input type="hidden" name="agent" class="mouse_agent_name_" id="mouse_agent_name_<?php echo $new['id']; ?>" value="<?php echo $new['agent']; ?>" readonly>
                                                            <input type="hidden" name="agent_fk_id" class="mouse_agent_fk_id_" id="mouse_agent_fk_id_<?php echo $new['id']; ?>" value="<?php echo $new['agent_fk_id']; ?>" readonly>

                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="form-group mb-2">
                                                                    <label for="mouse_agent_dropdown_<?php echo $new['id']; ?>">Agent</label><br>
                                                                        <div class="ui search selection dropdown mouse_agent_dropdown" data-id="<?php echo $new['id']; ?>">
                                                                        ...
                                                                        <div id="agent_id_error_<?php echo $new['id']; ?>" class="text-danger"></div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group mb-2">
                                                                    <label>Status</label>
                                                                        <select class="form-control" id="status" name="status" onchange="mousestatusedit(this)" >
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <label>Condition</label>
                                                                        <select class="form-control" id="name" name="mouse_condition" onchange="mousecondtionedit(this)" >
                                                                            <option value="<?php echo $new['mouse_condition']; ?>"><?php echo $new['mouse_condition']; ?></option>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12 text-right">
                                                                    ...
                                                                    <button type="submit" id="updatemouse" class="btn btn-success">Save</button>
                                                                </div>
                                                            </div>
                                                        </form>
                                                        </div>
      ...
      <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Add Mouse</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="<?= site_url('add_mouse') ?>" method="POST">
                    <div class="modal-body">

                        <div class="form-group">
                            <label for="agentID">Equipment ID</label>
                            <input type="text" class="form-control" id="mouse_equip_id" name="equip_id" required>
                            <div id="mouse_equip_id_error" class="text-danger"></div> <!-- Error message container -->
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="mouse_condition" name="mouse_condition" onchange = "conditioneditmouse(this)">
                              <option value="New">New</option>
                              <option value="Reassigned">Reassigned</option>
                              <option value="Frequently Used">Frequently Used</option>
                              <option value="">Others</option>
