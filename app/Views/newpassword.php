...
<form action="<?= site_url('update/Password') ?>" method="POST" enctype="multipart/form-data" class="login100-form validate-form">
    ...
    <div class="wrap-input100 validate-input <?= $validation->hasError('password') ? 'alert-validate' : ''; ?>" data-validate="<?= $validation->hasError('password') ? $validation->getError('password') : 'Valid token is required'; ?>">
    ...
    <div class="wrap-input100 validate-input <?= $validation->hasError('confirm_password') ? 'alert-validate' : ''; ?>" data-validate="<?= $validation->hasError('confirm_password') ? $validation->getError('confirm_password') : 'Valid token is required'; ?>">
